...
const MAX_CARTAS = 14;
const PAPAGAIOS = [
  "farmacia-popular.jpg", "asepxia.png", "horario.png", 
  "nebulizador.png", "tira-leite-automatico.png", "huggies.png", 
  "dermacyd.png"
];
...
function construirCarta(indicePapagaio) {
  ...
  <div class="carta" onclick="selecionarCarta(this)">
    <div class="face-carta frente">
      <img src="img/farma_rocha.png" alt="${papagaio}" />
    </div>
    <div class="face-carta verso">
      <img src="img/${papagaio}" alt="${papagaio}" />
    </div>
  </div>
  `;
